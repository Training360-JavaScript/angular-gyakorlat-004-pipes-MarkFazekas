...
export class FilterPipe implements PipeTransform {
  ...
  transform(value: any[], phrase: string, key: string = ''): any {
     ...
     */
    if(Array.isArray(value) !== true || phrase === undefined || phrase === null || key === undefined || key === null || key === ""){
      return value;
    }
    ...
    return value.filter((item => {
      const compareValue: string = String(item[key]).toLocaleLowerCase();
      return compareValue.includes(phrase.toLocaleLowerCase());
    }))
